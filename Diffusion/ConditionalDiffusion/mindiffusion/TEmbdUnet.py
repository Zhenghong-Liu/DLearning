...
class TimeEmbedding(nn.Module):
    def __init__(self, emb_dim):
        ...
        self.linear1 = nn.Linear(1, emb_dim, bias=False)
...
class Unet(nn.Module):
    def __init__(self, input_channels, output_channels, bilinear = False):
        ...
        self.time_embedding = TimeEmbedding(1024 // factor)
    ...
    def forward(self, x, t):
        ...
        temb = self.time_embedding(t).view(x.size(0), -1, 1, 1)
        x5 = x5 + temb
    ...
    def use_checkpointing(self):
        ...
        self.time_embedding = torch.utils.checkpoint(self.time_embedding)
